package com.bxkcli.mcp.transport;
    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[bxkcli] stdout reader stopped: " + e.getMessage());
            }
        }, "bxkcli-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[bxkcli] stderr reader stopped: " + e.getMessage());
            }
        }, "bxkcli-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }
