...
import com.bxkcli.tui.history.ConversationSnapshot;
import com.bxkcli.tui.pane.CenterPane;
import com.bxkcli.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    private final BxkCliConfig config;
    ...
    public TuiSessionController(BxkCliConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "bxkcli-tui-agent-runner");
