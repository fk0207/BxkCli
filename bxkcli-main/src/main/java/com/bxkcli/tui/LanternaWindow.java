...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(BxkCliConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("BxkCLI v16.0.0");
