package com.bxkcli.render.inline;

import com.bxkcli.hitl.ApprovalRequest;
import com.bxkcli.hitl.ApprovalResult;
 ...
 * 工具调用块、行内 diff、HITL 单字符提示、palette 等高级特性，
 * 对应方法委托给 {@link PlainRenderer} 兜底。
 */
