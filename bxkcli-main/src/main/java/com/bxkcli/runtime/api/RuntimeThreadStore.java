...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = System.getProperty("bxkcli.runtime.dir");
        if (configured == null || configured.isBlank()) {
            configured = System.getenv("BXKCLI_RUNTIME_DIR");
        }
        if (configured == null || configured.isBlank()) {
            configured = Path.of(System.getProperty("user.home"), ".bxkcli", "runtime").toString();
        }
