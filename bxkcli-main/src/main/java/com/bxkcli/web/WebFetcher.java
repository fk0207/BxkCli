...
public class WebFetcher {
    ...
    public static final int DEFAULT_MAX_BYTES = 5 * 1024 * 1024; // 响应体上限 5MB
    private static final long DEFAULT_TIMEOUT_SECONDS = 30L; // 30 秒整体超时
    ...
    public RawResponse fetch(String url) throws IOException {
        Request request = new Request.Builder()
                ...
                .header("User-Agent",
                        "Mozilla/5.0 (compatible; bxkcli-web-fetch/1.0)")
                .get()
                .build();
