...
import com.bxkcli.mcp.mention.AtMentionCompleter;
...
final class BxkCliCompleter implements Completer {
    private final Supplier<List<McpResourceDescriptor>> resourceSupplier;
    private final Supplier<List<Skill>> skillSupplier;

    BxkCliCompleter(Supplier<List<McpResourceDescriptor>> resourceSupplier) {
