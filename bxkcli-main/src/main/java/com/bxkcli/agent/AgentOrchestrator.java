...
public class AgentOrchestrator {
     ...
     */
    public void setSkillSystem(com.bxkcli.skill.SkillRegistry skillRegistry,
                               com.bxkcli.skill.SkillContextBuffer skillContextBuffer) {
    ...
    private void runBatchParallel(List<ExecutionStep> batch, List<ExecutionStep> steps,
        ...
        ExecutorService executor = Executors.newFixedThreadPool(parallelism, r -> {
            Thread t = new Thread(r, "bxkcli-multi-agent");
            t.setDaemon(true);
            return t;
        });
