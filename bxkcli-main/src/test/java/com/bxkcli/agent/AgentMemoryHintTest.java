...
import com.bxkcli.llm.GLMClient;
...
class AgentMemoryHintTest {
    ...
    void explicitChromeRememberRequestStoresSitePreferenceInLongTermMemory() {
        String oldMemoryDir = System.getProperty("bxkcli.memory.dir");
        System.setProperty("bxkcli.memory.dir", tempDir.toString());
        try {
            ...
            if (oldMemoryDir == null) {
                System.clearProperty("bxkcli.memory.dir");
            } else {
                System.setProperty("bxkcli.memory.dir", oldMemoryDir);
            }
        }
    }
