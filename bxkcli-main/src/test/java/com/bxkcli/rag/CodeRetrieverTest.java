...
class CodeRetrieverTest {
    ...
    private static final String TEST_PROJECT = "/tmp/bxkcli-code-retriever";
    private VectorStore store;

    @BeforeEach
    void setUp() throws Exception {
        System.setProperty("bxkcli.rag.dir", "/tmp/bxkcli-test-rag-retriever");
