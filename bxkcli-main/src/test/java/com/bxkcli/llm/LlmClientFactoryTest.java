...
class LlmClientFactoryTest {
    ...
    void createsGlm5vTurboClientWithMultimodalEndpoint() {
        BxkCliConfig config = new BxkCliConfig();
        config.getProviders().put("glm",
                new BxkCliConfig.ProviderConfig("test-glm-key", null, "glm-5v-turbo"));
    ...
    void createsStepClientFromConfiguredProvider() {
        ...
        config.getProviders().put("step",
                new BxkCliConfig.ProviderConfig("test-step-key", null, "step-3.5-flash-2603"));
    ...
    void createsStepClientFromStepfunAliasAndCustomBaseUrl() {
        ...
        config.getProviders().put("step",
                new BxkCliConfig.ProviderConfig(
                        "test-step-key",
    ...
    void returnsNullForUnknownProvider() {
        BxkCliConfig config = new BxkCliConfig();
        config.getProviders().put("unknown", new BxkCliConfig.ProviderConfig("test-key", null, "unknown-model"));
