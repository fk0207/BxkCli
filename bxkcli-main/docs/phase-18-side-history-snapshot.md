...
新增包：`src/main/java/com/bxkcli/snapshot/`
...
```text
~/.bxkcli/snapshots/<project_hash>/<worktree_hash>/.git
```
...
```bash
-Dbxkcli.snapshot.enabled=false
-Dbxkcli.snapshot.max=50
-Dbxkcli.snapshot.excludes=...
```
