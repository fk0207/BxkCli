...
```text
src/main/java/com/bxkcli/prompt/
...
2. 用户级覆盖：`~/.bxkcli/prompts/...`
3. 项目级覆盖：`.bxkcli/prompts/...`

例如：

```text
~/.bxkcli/prompts/base.md
~/.bxkcli/prompts/modes/agent.md
.bxkcli/prompts/modes/team-worker.md
```
...
- [x] 支持用户级覆盖 `~/.bxkcli/prompts/...`
- [x] 支持项目级覆盖 `.bxkcli/prompts/...`
- [x] 校验 `## Language`
- [x] ReAct 接入
